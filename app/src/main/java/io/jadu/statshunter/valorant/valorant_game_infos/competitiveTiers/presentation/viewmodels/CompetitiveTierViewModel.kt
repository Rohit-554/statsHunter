package io.jadu.statshunter.valorant.valorant_game_infos.competitiveTiers.presentation.viewmodels
...
@HiltViewModel
class CompetitiveTierViewModel @Inject constructor(private val getCeremoniesUseCase: GetCeremoniesUseCase):ViewModel() {
